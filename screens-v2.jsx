    ...
    <div className="paper-bg screen-scroll" style={{ height:'100%', overflowY:'auto', padding:'56px 22px 80px', position:'relative' }}>
      ...
      <div style={{
        ...
        {PILLARS.map((p, i) => {
          ...
          const flipped = !!a;
          return (
            <button type="button" key={p.key} onClick={() => setActivePillar(p.key)}
              style={{
      ...
      <div onClick={(e)=>e.stopPropagation()} style={{
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
          {pillar.options.map((o) => {
            ...
            return (
              <button type="button" key={o.v} onClick={() => onPick(o)}
                style={{
  ...
  return (
    <div className="paper-bg screen-scroll" style={{ height:'100%', overflowY:'auto', padding:'56px 16px 80px' }}>
      ...
      <div style={{ marginTop: 18, display: 'flex', flexDirection: 'column', gap: 10 }}>
        <button type="button" onClick={() => openModal('lm')} style={{
        ...
        <button type="button" onClick={() => openModal('wisdom')} style={{
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', justifyContent: 'center', gap: 10 }}>
          ...
          <button type="button" onClick={shareNative} title="แชร์ / คัดลอกลิงก์" style={{
          ...
          {/* Save card */}
          <button type="button" onClick={() => downloadShareCard(score, status, statusColor, answers)} title="บันทึกการ์ดเป็นรูป" style={{
          ...
          {/* LINE */}
          <button type="button" onClick={() => shareTo('line')} title="แชร์ LINE" style={{
          ...
          {/* Facebook */}
          <button type="button" onClick={() => shareTo('fb')} title="แชร์ Facebook" style={{
  ...
  return (
    <ModalShell onClose={onClose} accent="#b3503a">
      ...
      <div style={{ marginTop: 14, display: 'flex', flexDirection: 'column', gap: 8 }}>
        ...
        <button type="button" onClick={() => window.open('https://line.me/R/ti/p/@hpc10', '_blank')} style={{
          ...
          <div>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 8 }}>
              {concerns.map(c => {
                ...
                return (
                  <button type="button" key={c.v} onClick={() => setForm({...form, concern: c.v})}
                    style={{
        ...
        {library.map(p => {
          ...
          return (
            <div key={p.key} style={{
              ...
              <button type="button" onClick={() => setExpanded(open ? null : p.key)} style={{
              ...
              {open && (
                <div className="float-up" style={{ padding: '0 12px 12px' }}>
                  ...
                  <button type="button" onClick={() => window.open(p.pdf, '_blank')} style={{
